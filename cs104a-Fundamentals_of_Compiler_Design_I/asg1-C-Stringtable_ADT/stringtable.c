/***********************************************************************
 * $Id: stringtable.c,v 1.24 2011-10-07 17:04:52-07 dmfrank - $
...
void delete_stringnode (stringnode_ref node) {
   if (node == NULL)
      errprintf ("%s: %s: %s: %s\n", "Error", "stringtable.c",
                 "delete_stringnode()", "null string node reference");
...
void delete_stringtable (stringtable_ref table) {
   if (table == NULL)
      errprintf ("%s: %s: %s: %s\n", "Error", "stringtable.c",
                 "delete_stringtable()", "null string table reference");
...
/*   // print an error message if a match was not found
   if (curr == NULL)
      errprintf ("%s: %s: %s: %s\n", "Error", "stringtable.c",
                 "find()", "no match found");
*/
...
cstring peek_stringtable (stringnode_ref node) {
   ...
   if (node == NULL)
      errprintf ("%s: %s: %s: %s\n", "Error", "stringtable.c",
                 "peek_stringtable()", "null string node reference");
   return node->str;
}
...
void double_capacity (stringtable_ref table) {
   ...
   if (table == NULL)
      errprintf ("%s: %s: %s: %s\n", "Error", "stringtable.c",
                 "double_capacity()", "null string table reference");
...
stringnode_ref intern_stringtable (stringtable_ref table,
   ...
   if (table == NULL)
      errprintf ("%s: %s: %s: %s\n", "Error", "stringtable.c",
                 "intern_stringtable()", "null string table reference");
   // print error message if the character pointer (cstring) is null
   if (string == NULL)
      errprintf ("%s: %s: %s: %s\n", "Error", "stringtable.c",
                 "intern_stringtable()", "null cstring");
