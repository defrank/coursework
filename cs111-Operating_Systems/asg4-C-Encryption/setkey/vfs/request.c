...
/*===========================================================================*
 *				req_setkey	      			     * CMPS 111 Project 4
 *===========================================================================*/
PUBLIC int req_setkey(
  int fs_e,
  /*message *mptr*/
)
{
  ...
  /* Fill in request message */
  m.m_type = REQ_SETKEY;
  //m.m_m1_i1 = mptr->m_m1_i1;
  //m.m_m1_i2 = mptr->m_m1_i2;
  //m.REQ_INODE_NR = inode_nr;
  //m.REQ_MODE = rmode;
